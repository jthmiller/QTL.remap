...
ELR3=$(sbatch -J "NBH.ripple" --parsable --dependency=afterany:$ELR2 $scriptdir/MAP/18.8.22.MAP_qtl_3.sh ELR)
...
NEW6=$(sbatch -J "NEW.scan2" --parsable --dependency=afterany:$NEW5 $scriptdir/QTL/18.8.22.SCAN2.sh NBH)
