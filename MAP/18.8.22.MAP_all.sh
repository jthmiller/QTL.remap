...
NBH4=$(sbatch -J "NBH.final" --parsable --dependency=afterany:$NBH3 $scriptdir/QTL/18.8.22.MAP_qtl_4.sh NBH)
...
NBH3=$(sbatch -J "NBH.ripple" --parsable --dependency=afterany:$ELR2 $scriptdir/MAP/18.8.22.MAP_qtl_3.sh ELR)
ELR3=$(sbatch -J "ELR.final"  --parsable --dependency=afterany:$ELR3 $scriptdir/MAP/18.8.22.MAP_qtl_4.sh ELR)
ELR4=$(sbatch -J "ELR.scan" --parsable --dependency=afterany:$ELR4 $scriptdir/QTL/18.8.22.SCAN.sh ELR)
ELR5=$(sbatch -J "ELR.scan2" --parsable --dependency=afterany:$ELR5 $scriptdir/QTL/18.8.22.SCAN2.sh ELR)
#Newark
...
NBH3=$(sbatch -J "NEW.ripple" --parsable --dependency=afterany:$NEW2 $scriptdir/MAP/18.8.22.MAP_qtl_3.sh NEW)
NEW3=$(sbatch -J "NEW.final" --parsable --dependency=afterany:$NEW3 $scriptdir/MAP/18.8.22.MAP_qtl_4.sh NEW)
NEW4=$(sbatch -J "NEW.scan" --parsable --dependency=afterany:$NEW4 $scriptdir/QTL/18.8.22.SCAN.sh NEW)
NEW5=$(sbatch -J "NEW.scan2" --parsable --dependency=afterany:$NEW5 $scriptdir/QTL/18.8.22.SCAN2.sh NBH)
