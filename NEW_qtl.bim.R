...
if (pop == "NEW") {
  ...
  png(paste("/home/jmiller1/public_html/new_effectplot", pop, qtl[1],"_",qtl[2], "_pxg.png"))
    effectplot(cross.18, mname1 = qtl[1], mname2 = qtl[2])
  dev.off()

  png(paste("/home/jmiller1/public_html/new_effectplot", pop, qtl[2],"_",qtl[1], "_pxg.png"))
...
capture.output(c(summary(fit),summary(fit.nomis)), file = "/home/jmiller1/public_html/NEW_out.txt")
